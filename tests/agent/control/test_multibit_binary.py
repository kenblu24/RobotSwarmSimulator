...
def check_mbc_agent(controller: MultiBinaryController, sens_values: list[bool], expected: tuple[float, float]):
    ...
    assert isinstance(controller, MultiBinaryController)
