...
var_names = allowed_builtins_names + allowed_numpy_names  # for detecting undefined variables and replacing with strings
...
def safe_eval(expr, variables=()):
    ...
    for subnode in ast.walk(node):
        ...
        if isinstance(subnode, ast.Name):
            if subnode.id not in var_names:
                undefined_names.append(var_names)
