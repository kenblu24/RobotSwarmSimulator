...
controller = VoronoiController(agent=None, parent=None, world = world)
...
# spawner
spawner = PointAgentSpawner(world, n=2, facing="away", avoid_overlap=True, agent=agent, mode="oneshot")
