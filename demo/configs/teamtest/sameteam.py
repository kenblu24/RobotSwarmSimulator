...
agent1_config = MazeAgentConfig(angle=.0, position=(2, 5), agent_radius=0.1,team="Red")
agent1 = MazeAgent(agent1_config, world)
agent1.controller = controller
sensor = BinaryFOVSensor(agent1,target_team="Black", theta=0.45, distance=2,)
agent1.sensors.append(sensor)

world.population.append(agent1)


agent2_config = MazeAgentConfig(angle=3.14, position=(8,5), agent_radius=0.1, team="Red")
agent2 = MazeAgent(agent2_config,world)
agent2.controller = controller
sensor2 = BinaryFOVSensor(agent2,target_team="Black", theta=0.45,distance=2,)
